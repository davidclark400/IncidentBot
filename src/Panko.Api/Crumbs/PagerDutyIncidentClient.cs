    ...
    ICredentialProvider credentials)
{
    ...
    private readonly ConnectorTransport _transport = crumbSources.For(CrumbSourceRegistry.PagerDuty);
    ...
    {
        var serviceIds = authorizedServiceIds
        ...
        var authorizedServices = serviceIds.ToHashSet(StringComparer.Ordinal);
        ...
        var items = incidents.EnumerateArray()
            ...
            .Where(incident => authorizedServices.Contains(incident.ServiceId))
            .ToArray();
