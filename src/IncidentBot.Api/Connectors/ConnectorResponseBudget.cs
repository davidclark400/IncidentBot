...
/// <summary>
/// Runs a planned sequence of connector response reads under one cumulative byte limit.
...
/// </summary>
internal sealed class ConnectorResponseBudget
{
    ...
    public ConnectorResponseBudget(
        int scopeMaximumBytes,
        int connectorMaximumBytes,
    ...
    public Task<string?> TryReadTextAsync(
        ...
        TryReadAsync(
            ...
            sendAsync,
            (response, maximumReadBytes, observeBytesRead, ct) =>
                ConnectorUtilities.ReadBoundedTextAsync(
                    response,
                    maximumReadBytes,
                    ct,
                    observeBytesRead),
        ...
        where T : class
    {
        ...
        catch (ConnectorResponseLimitExceededException)
        {
