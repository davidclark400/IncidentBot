...
public sealed class KafkaDashboardGenerator
{
        ...
        KafkaMetricPlan plan)
    {
        ...
        var dashboard = new JsonObject
        {
            ...
            ["description"] =
                $"Panko-generated Kafka Crumb dashboard for Recipe {recipeId}; generated from metric pack {plan.MetricPackId}.",
            ["editable"] = false,
            ...
            ["refresh"] = "30s",
            ["schemaVersion"] = 39,
            ["tags"] = new JsonArray("panko", "kafka", "panko-generated", recipeId),
            ["templating"] = new JsonObject
            {
                ["list"] = new JsonArray(
                    Variable("recipe", "Panko Recipe", [recipeId], multi: false),
            ...
            ["timezone"] = "browser",
            ["title"] = $"Panko Kafka — {recipeId}",
            ["uid"] = KafkaDashboardIdentity.Uid(recipeId),
            ["version"] = 1,
            ["weekStart"] = ""
        };
        ...
        int y)
    {
        ...
        return new JsonObject
        {
            ...
            ["title"] = metric.Title,
            ["description"] =
                $"Panko metric {metric.Id}; Crumb mode {metric.CrumbMode}; reducer {metric.TimeReducer}; unit {metric.Unit}.",
            ["type"] = "timeseries",
    ...
    private static JsonObject Variable(string name, string label, IEnumerable<string> allowed, bool multi)
    {
        ...
        return new JsonObject
        {
            ...
            // Keep URL sync disabled so dashboard queries remain Recipe-allowlisted.
            ["skipUrlSync"] = true
        };
    }
