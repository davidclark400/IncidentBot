...
const palette = {
  ink: "#172554",
  muted: "#475569",
  admissionFill: "#dbeafe",
  admissionStroke: "#2563eb",
...
function diagram({ name, width, height, definitions, connections }) {
  ...
  // Keep Crumb sources behind containers so routed arrows stay legible without crossing labels.
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" role="img" style="max-width: 100%; height: auto;">
  <title>Panko flow diagram</title>
  <defs>
...
diagram({
  name: "panko-numbered-process",
  width: 1600,
  height: 900,
  definitions: [
    { id: "numbered-header", x: 40, y: 30, width: 1520, height: 90, text: "Panko process — document section map", fill: palette.headerFill, stroke: palette.headerStroke, textColor: palette.headerText, fontSize: 30 },

    { id: "section-1", x: 70, y: 190, width: 320, height: 160, text: "1. Case admission & scheduling\n\nValidate • dedupe • enqueue", fill: palette.admissionFill, stroke: palette.admissionStroke, fontSize: 21 },
    { id: "section-2", x: 450, y: 190, width: 320, height: 160, text: "2. Case orchestration\n\nLoad • sign • collect", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke, fontSize: 21 },
    { id: "section-3", x: 830, y: 190, width: 320, height: 160, text: "3. Crumb-source searches\n\nPagerDuty • Nomad • GitLab\nGrafana • VictoriaLogs", fill: palette.sourceFill, stroke: palette.sourceStroke, fontSize: 20 },
    { id: "section-4", x: 1210, y: 190, width: 320, height: 160, text: "4. Prepare Crumbs for AI\n\nDedupe • rank\nBound • synthesize", fill: palette.prepFill, stroke: palette.prepStroke, fontSize: 20 },

    { id: "section-5", x: 1210, y: 520, width: 320, height: 160, text: "5. Compose Case File & Pattern\n\nProject • match • version", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke, fontSize: 21 },
    { id: "section-6", x: 830, y: 520, width: 320, height: 160, text: "6. Commit PostgreSQL writes\n\nCase File • Crumbs\nTrail • outbox", fill: palette.persistFill, stroke: palette.persistStroke, fontSize: 20 },
    { id: "section-7", x: 450, y: 520, width: 320, height: 160, text: "7. Publish web & Slack output\n\nSignalR • post/update • rebuild", fill: palette.outputFill, stroke: palette.outputStroke, fontSize: 20 },
...
diagram({
  name: "panko-trigger-to-output",
  width: 1880,
  height: 1060,
  definitions: [
    { id: "overview-header", x: 40, y: 30, width: 1800, height: 90, text: "Panko: PagerDuty trigger to live Case File", fill: palette.headerFill, stroke: palette.headerStroke, textColor: palette.headerText, fontSize: 30 },

    { id: "event", x: 40, y: 175, width: 220, height: 145, text: "1. PagerDuty\nincident event", fill: palette.admissionFill, stroke: palette.admissionStroke, fontSize: 20 },
    { id: "gate", x: 300, y: 175, width: 270, height: 145, text: "2. Webhook gate\n≤256 KiB payload\nHMAC-SHA256 signature", fill: palette.admissionFill, stroke: palette.admissionStroke },
    { id: "parse", x: 610, y: 175, width: 270, height: 145, text: "3. Parse + Recipe\nservice + labels select scope\nfilter persisted labels", fill: palette.admissionFill, stroke: palette.admissionStroke },
    { id: "accept", x: 920, y: 175, width: 300, height: 145, text: "4. PostgreSQL transaction\ndedupe webhook event ID\nupsert Case state", fill: palette.persistFill, stroke: palette.persistStroke },
    ...
    { id: "worker", x: 1570, y: 175, width: 270, height: 145, text: "6. Case worker\nlease work item\nper-Case run guard", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke },

    { id: "load", x: 60, y: 430, width: 280, height: 160, text: "7. Load Case\nresolve current Recipe\nsave provisional Signature\nfind possible Pattern", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke },
    { id: "initial", x: 380, y: 430, width: 280, height: 160, text: "8. Initial Case File\nstatus: collecting\nCrumb sources: pending\nSignalR + Slack outbox", fill: palette.outputFill, stroke: palette.outputStroke },
    ...
    { id: "llm", x: 1420, y: 430, width: 360, height: 160, text: "11. LiteLLM synthesis\nstrict JSON schema + exact citations\ntimeout or invalid output →\ndeterministic Case File continues", fill: palette.prepFill, stroke: palette.prepStroke },

    { id: "final-pattern", x: 60, y: 725, width: 320, height: 165, text: "12. Final Pattern match\ndeterministic Signature\nmatch or create Pattern\nAI output is never identity input", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke },
    { id: "compose", x: 420, y: 725, width: 320, height: 165, text: "13. Compose Case File\nCrumbs + Trail + sources\ncausal candidate sequence\nAI or explicit unavailable state", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke },
    { id: "save", x: 780, y: 725, width: 360, height: 165, text: "14. Atomic Case File save\noptimistic version check\nCase File + Crumbs + Trail\ninsert Slack outbox item", fill: palette.persistFill, stroke: palette.persistStroke },
    { id: "signalr", x: 1200, y: 725, width: 270, height: 165, text: "15. Web output\nSignalR version notification\nclient refetches Case File\n5s polling fallback", fill: palette.outputFill, stroke: palette.outputStroke },
    { id: "slack", x: 1510, y: 725, width: 300, height: 165, text: "16. Slack output\noutbox worker loads latest Case File\npost once, then update by ts\nretry with backoff", fill: palette.outputFill, stroke: palette.outputStroke },

    { id: "resilience", x: 190, y: 955, width: 1500, height: 70, text: "Durability rule: Crumb-source, Pattern, AI, and Slack failures degrade or retry independently; a committed deterministic Case File remains responder-visible.", fill: palette.neutralFill, stroke: palette.neutralStroke, fontSize: 19 },
  ],
  connections: [
    ...
    { id: "a-llm-pattern", from: "llm", to: "final-pattern", fromSide: "bottom", toSide: "top", via: [[1600, 655], [220, 655]] },
    { id: "a-pattern-compose", from: "final-pattern", to: "compose" },
...
diagram({
  name: "panko-source-searches",
  width: 1920,
  height: 1380,
  definitions: [
    { id: "sources-header", x: 40, y: 30, width: 1840, height: 90, text: "Crumb collection: what each source searches", fill: palette.headerFill, stroke: palette.headerStroke, textColor: palette.headerText, fontSize: 30 },
    { id: "scope", x: 240, y: 160, width: 1440, height: 130, text: "Shared input: Recipe-scoped service + safe labels • window = openedAt − 30 min through now • max items/bytes • Recipe revision\nEach enabled Crumb source runs concurrently using native API or configured MCP transport.", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke, fontSize: 20 },

    { id: "pagerduty", x: 40, y: 360, width: 350, height: 390, text: "PagerDuty\n\nGET /incidents/{pagerdutyId}\n\nExact incident lookup, not broad search.\nCaptures created time, current status,\nseverity and incident link.\n\nCrumb: incident state\nTrail: PagerDuty event", fill: palette.sourceFill, stroke: palette.sourceStroke, fontSize: 18 },
    { id: "gitlab", x: 430, y: 330, width: 700, height: 470, text: "GitLab — per allowlisted project / branch / environment\n\n• Merged MRs updated after window start; retain created + merged events\n• Commits since/until; inspect diffs for up to 5 commits, only relevantPaths\n• Parent + child pipelines updated within the window (paginated)\n• Deployments filtered by configured environments and exact window\n• Failed pipelines first; query failed current jobs, failed retry history,\n  then canceled jobs; collapse retry families and rank earliest hard failure\n• Read bounded useful trace tails for selected failed job families\n\nProduces change, pipeline, failed-step, deployment and code-reference Crumbs.", fill: palette.sourceFill, stroke: palette.sourceStroke, fontSize: 17 },
...
diagram({
  name: "panko-ai-persistence-output",
  width: 1920,
  height: 1340,
  definitions: [
    { id: "ai-header", x: 40, y: 30, width: 1840, height: 90, text: "From Crumb sources to AI, PostgreSQL, web and Slack", fill: palette.headerFill, stroke: palette.headerStroke, textColor: palette.headerText, fontSize: 30 },

    { id: "results", x: 40, y: 170, width: 340, height: 210, text: "CrumbSourceResult[]\n\nsource health + diagnostic\nCrumbs\nTrail candidates\nresponder links\nduration", fill: palette.sourceFill, stroke: palette.sourceStroke, fontSize: 19 },
    ...
    { id: "repair", x: 40, y: 500, width: 390, height: 220, text: "5. Validate model output\n\nOnly digest Crumb IDs, code refs and\nsummary reference IDs survive.\nDrop unsupported diagnoses; clamp ranks\nand strengths; cap summary at 1200 chars.\nHash reuse skips unchanged synthesis.", fill: palette.prepFill, stroke: palette.prepStroke, fontSize: 18 },
    { id: "compose-case-file", x: 480, y: 500, width: 390, height: 220, text: "6. Compose deterministic Case File\n\nmerge previous + current Crumbs by ID\nretain ≤500 Crumbs, ≤250 Trail entries\nsource health + links + high-signal count\nbuild chronology-based candidate sequence\nattach AI complete/unavailable state", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke, fontSize: 18 },
    { id: "signature", x: 920, y: 500, width: 390, height: 220, text: "7. Final Pattern match\n\nextract stable Crumb features\ngenerate versioned deterministic Signature\nfind scoped historical candidates\nmatch or create Pattern\nupdate lifecycle + occurrence history", fill: palette.orchestrationFill, stroke: palette.orchestrationStroke, fontSize: 18 },
    { id: "transaction", x: 1360, y: 500, width: 520, height: 220, text: "8. One PostgreSQL transaction\n\ncases.case_file_version + case_file_json\ncrumbs + trail_entries rows\nslack.case-file outbox item\noptional +1 minute collecting/stuck check", fill: palette.persistFill, stroke: palette.persistStroke, fontSize: 18 },

    { id: "database", x: 40, y: 850, width: 560, height: 280, text: "PostgreSQL system of record\n\ncases • case_origin_receipts • work_items\ncrumbs • trail_entries • outbox\ncase_signatures • patterns\npattern_occurrences\n\nWork lease: 2 min; exponential retry ≤60s\nOutbox lease: 1 min; exponential retry ≤300s", fill: palette.persistFill, stroke: palette.persistStroke, fontSize: 18 },
    { id: "web", x: 660, y: 850, width: 420, height: 280, text: "Web / SignalR\n\nPublish CaseUpdated(version, sections)\nand CaseStatusChanged.\nClient joins the Case group, ignores stale\nversions, refetches with ETag and uses 5s\npolling when disconnected or Case File is pending.", fill: palette.outputFill, stroke: palette.outputStroke, fontSize: 18 },
    { id: "slack-output", x: 1140, y: 820, width: 740, height: 330, text: "Slack — one durable message per Case\n\nOutbox worker loads the latest committed Case + Case File.\nFirst delivery: chat.postMessage; save returned timestamp. Later: chat.update.\nBlocks include service/state/agent/urgency, Pattern match, up to 3 diverse\ntop Crumbs, AI summary or deterministic fallback, candidate sequence,\nsource-health icons and a live Case File link. A delayed collecting check may add\na Rebuild Case File button; Socket Mode acknowledges and queues a fresh work item.", fill: palette.outputFill, stroke: palette.outputStroke, fontSize: 18 },

    { id: "failure", x: 120, y: 1210, width: 1680, height: 90, text: "Failure behavior: Crumb-source errors become unavailable results; AI errors become synthesis=unavailable; Pattern errors become unavailable.\nSlack errors stay in the outbox. None erases the committed deterministic Case File.", fill: palette.neutralFill, stroke: palette.neutralStroke, fontSize: 19 },
  ],
  connections: [
    ...
    { id: "a-repair-compose", from: "repair", to: "compose-case-file" },
    { id: "a-compose-signature", from: "compose-case-file", to: "signature" },
    { id: "a-signature-transaction", from: "signature", to: "transaction" },
